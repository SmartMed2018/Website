        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="page-heading">
              <h1>Contact Us</h1>
              <span class="subheading">Anything You need, we are here.</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <!-- Contact Form - Enter your email address 
		  
		  +3on line 19 of the mail/contact_me.php file to make this form work. -->
          <!-- WARNING: Some web hosts do not allow emails to be sent through forms to common mail hosts like Gmail or Yahoo. It's recommended that you use a private domain email address! -->
          <!-- To use the contact form, your site must be on a live web host with PHP! The form will not work locally! -->
           <p></p> We will be happy to assist you in any Qustion or inquiry. You can contact us in the following ways:</p>
            
            Adress:  2 Rabenu Yeruham St., Tel Aviv-Jaffa <br>
            
            Phone: 03-7493492 <br>
            
            Fax: 03-3750303 <br>
            
            Email: SmartMed@SmartMed.com
            </div>
          </form>
        </div>
      </div>
